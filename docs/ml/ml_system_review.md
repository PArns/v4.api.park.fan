...
- **Feature-Set:** Um umfasst zyklische Zeit-Features, Wetter, regionale Feiertage (`holiday_utils.py`), Park-Auslastung (`park_occupancy_pct`) sowie historische Wartezeiten und Volatilität.
