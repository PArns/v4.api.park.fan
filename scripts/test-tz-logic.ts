...
console.log('Park Timezone (Europe/Berlin):', formatInTimeZone(date, timezone, 'yyyy-MM-dd'));
...
console.log('Park Timezone (Europe/Berlin):', formatInTimeZone(date2, timezone, 'yyyy-MM-dd'));
