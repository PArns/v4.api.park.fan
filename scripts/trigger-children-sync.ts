...
async function triggerChildrenSync() {
    ...
    try {
        ...
        console.log('📊 The job will sync attractions, shows, AND restaurants for all parks.');
        console.log('⏳ This may take several minutes. Check application logs for progress.');
    } catch (error) {
