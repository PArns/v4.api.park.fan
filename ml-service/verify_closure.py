...
import ml_service.predict as predict
...
def test_attraction_closure():
    ...
    print("   - Schedule query now explicitly fetches attractionId and handles MAINTENANCE/CLOSED types.")
    print("   - create_prediction_features iterates over schedules and checks for attraction-specific closure.")
