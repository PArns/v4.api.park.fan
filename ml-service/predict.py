        ...
        for attraction_id in attraction_ids:
            ...
            if not attraction_data.empty:
                ...
                if park_tz:
                    ...
                    same_dow_vals = ts_local.apply(lambda x: _same_dow_avg_fast(x, [1, 2, 3, 4]))
                    ...
                    if len(future_indices) > 0:
                        df.loc[future_indices, "avg_wait_last_24h"] = same_dow_vals[future_mask].values
                        ...
                        hour_hists = np.where(row_is_weekends, rolling_avg_weekend, rolling_avg_weekday)
...
def predict_wait_times(
    ...
    for i, (idx, row) in enumerate(df_inference.iterrows()):
        ...
        # Enforce a minimum 5 min wait if the ride is considered operating by the model
