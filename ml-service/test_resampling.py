...
from features import remove_anomalies, engineer_features
...
for interval in RESAMPLING_INTERVALS:
    ...
    if len(df_resampled) > 100:
        ...
        df_resampled['day_of_week'] = pd.to_datetime(df_resampled['timestamp']).dt.dayofweek
