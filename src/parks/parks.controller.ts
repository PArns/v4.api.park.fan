...
export class ParksController {
   ...
   *
   * Alias route that redirects to the full geographic path.
   * Kept for backward compatibility.
   *
   * @deprecated Use the geographic route `/parks/:continent/:country/:city/:parkSlug/weather/forecast` instead.
  ...
  @UseInterceptors(new HttpCacheInterceptor(60 * 60)) // 1 hour HTTP cache
  @ApiOperation({
    summary: "Get weather forecast (alias)",
    description:
      "⚠️ **DEPRECATED**: Use the geographic route `/parks/:continent/:country/:city/:parkSlug/weather/forecast` instead. " +
      "This alias route is kept for backward compatibility only and will be removed in a future version.",
    deprecated: true,
  })
  @ApiResponse({
    status: 200,
   ...
   * Kept for backward compatibility.
   *
   * @deprecated Use the geographic route `/parks/:continent/:country/:city/:parkSlug/weather` instead.
   * This route will be removed in a future version.
   *
   * @param slug - Park slug
   * @param from - Start date (YYYY-MM-DD, optional, defaults to 30 days ago)
  ...
  @UseInterceptors(new HttpCacheInterceptor(60 * 60)) // 1 hour HTTP cache
  @ApiOperation({
    summary: "Get weather history/forecast (alias)",
    description:
      "⚠️ **DEPRECATED**: Use the geographic route `/parks/:continent/:country/:city/:parkSlug/weather` instead. " +
      "This alias route is kept for backward compatibility only and will be removed in a future version.",
    deprecated: true,
  })
  @ApiResponse({
   ...
   *
   * @deprecated Use the geographic route `/parks/:continent/:country/:city/:parkSlug/schedule` instead.
   * This route will be removed in a future version.
   *
   * @param slug - Park slug
   * @param from - Start date (YYYY-MM-DD, optional)
  ...
  @UseInterceptors(new HttpCacheInterceptor(60 * 60)) // 1 hour HTTP cache
  @ApiOperation({
    summary: "Get schedule range (alias)",
    description:
      "⚠️ **DEPRECATED**: Use the geographic route `/parks/:continent/:country/:city/:parkSlug/schedule` instead. " +
      "This alias route is kept for backward compatibility only and will be removed in a future version.",
    deprecated: true,
  })
  @ApiResponse({
   ...
   * Kept for backward compatibility.
   *
   * @deprecated Use the geographic route `/parks/:continent/:country/:city/:parkSlug/predictions/yearly` instead.
   * This route will be removed in a future version.
   */
  @Get(":slug/predictions/yearly")
  @UseInterceptors(new HttpCacheInterceptor(24 * 60 * 60)) // 24 hours HTTP cache
  @ApiOperation({
    summary: "Get yearly crowd predictions (alias)",
    description:
      "⚠️ **DEPRECATED**: Use the geographic route `/parks/:continent/:country/:city/:parkSlug/predictions/yearly` instead. " +
      "This alias route is kept for backward compatibility only and will be removed in a future version. " +
   ...
   * Kept for backward compatibility.
   *
   * @deprecated Use the geographic route `/parks/:continent/:country/:city/:parkSlug/attractions` instead.
   * This route will be removed in a future version.
   *
   * @param slug - Park slug
   * @throws NotFoundException if park not found
  ...
  @ApiOperation({
    summary: "List park attractions (alias)",
    description:
      "⚠️ **DEPRECATED**: Use the geographic route `/parks/:continent/:country/:city/:parkSlug/attractions` instead. " +
      "This alias route is kept for backward compatibility only and will be removed in a future version. " +
   ...
   * Kept for backward compatibility.
   *
   * @deprecated Use the geographic route `/parks/:continent/:country/:city/:parkSlug/attractions/:attractionSlug` instead.
   * This route will be removed in a future version.
   *
   * @param slug - Park slug
  ...
  @ApiOperation({
    summary: "Get attraction details (alias)",
    description:
      "⚠️ **DEPRECATED**: Use the geographic route `/parks/:continent/:country/:city/:parkSlug/attractions/:attractionSlug` instead. " +
      "This alias route is kept for backward compatibility only and will be removed in a future version.",
    deprecated: true,
  })
  @ApiResponse({
  ...
  async getAttractionInPark(
    ...
    // Check if park has geographic data for full path resolution
    if (park.continentSlug && park.countrySlug && park.citySlug) {
      // Use full geographic path method
      ...
      // Return with full integration
      return this.attractionIntegrationService.buildIntegratedResponse(
        attraction,
      );
    }

    // Fallback to old method if geographic data is missing
  ...
  /**
   * GET /v1/parks/:slug/rides/:rideSlug
   *
   * Alias route that redirects to the full geographic path.
   * Kept for backward compatibility. Uses the common term "rides".
   *
   * @deprecated Use the geographic route `/parks/:continent/:country/:city/:parkSlug/rides/:rideSlug` instead.
   * This route will be removed in a future version.
   *
   * @param slug - Park slug
   * @param rideSlug - Ride (attraction) slug
   * @throws NotFoundException if park or ride not found
   */
  @Get(":slug/rides/:rideSlug")
  @ApiOperation({
    summary: "Get ride details (alias)",
    description:
      "⚠️ **DEPRECATED**: Use the geographic route `/parks/:continent/:country/:city/:parkSlug/rides/:rideSlug` instead. " +
      "This alias route is kept for backward compatibility only and will be removed in a future version. " +
      "Uses the common term 'rides' as an alias for attractions.",
    deprecated: true,
  })
  @ApiResponse({
    status: 200,
  ...
  async getRideInPark(
    ...
    return this.getAttractionInPark(slug, rideSlug);
  }
