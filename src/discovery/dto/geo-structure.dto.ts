 ...
 * Park Reference DTO
 *
 * Minimal park information for listing/discovery endpoints.
 * attractions[] is intentionally omitted here – only the count is needed
 * on listing pages. Full attraction data is available on the park-detail endpoint.
 */
