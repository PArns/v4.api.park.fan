...
export const MANUAL_ATTRACTION_METADATA: ManualAttractionMetadata[] = [
  ...
  // The wiki populates mayGetWet for 11 of ~7000 attractions, so its absence
  // means "unknown", never "stays dry". These are rides whose type leaves no
  // doubt: rapids, log flumes, splash battles, rafting and water coasters.
  // Curated July 2026 from the ride names, ambiguous cases left out — Heide
  // Park's "Peppas Bootsfahrt" is a gentle duck carousel around a lighthouse
  // and is deliberately absent.
  {
    citySlug: "farley",
    parkSlug: "alton-towers",
    attractionSlug: "congo-river-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "hellendoorn",
    parkSlug: "avonturenpark-hellendoorn",
    attractionSlug: "wild-waterval",
    mayGetWet: true,
  },
  {
    citySlug: "kasterlee",
    parkSlug: "bobbejaanland",
    attractionSlug: "wildwaterbaan",
    mayGetWet: true,
  },
  {
    citySlug: "tampa",
  ...
  },
  {
    citySlug: "tampa",
    parkSlug: "busch-gardens-tampa",
    attractionSlug: "stanley-falls-flume",
    mayGetWet: true,
  },
  {
    citySlug: "williamsburg",
    parkSlug: "busch-gardens-williamsburg",
    attractionSlug: "roman-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "sandusky",
    parkSlug: "cedar-point-shores",
    attractionSlug: "runaway-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "orlando",
    parkSlug: "disneys-blizzard-beach-water-park",
    attractionSlug: "runoff-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "nimtofte",
    parkSlug: "djurs-sommerland",
    attractionSlug: "rio-grande-rafting",
    mayGetWet: true,
  },
  {
    citySlug: "allentown",
    parkSlug: "dorney-park",
    attractionSlug: "wildwater-cove",
    mayGetWet: true,
  },
  {
    citySlug: "allentown",
    parkSlug: "dorney-park",
    attractionSlug: "wildwater-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "allentown",
    parkSlug: "dorney-park",
    attractionSlug: "wildwater-river",
    mayGetWet: true,
  },
  {
    citySlug: "zator",
  ...
  },
  {
    citySlug: "fujikawaguchiko",
    parkSlug: "fuji-q-highland",
    attractionSlug: "nagashimasuka-shoot-the-chute",
    mayGetWet: true,
  },
  {
    citySlug: "blokhus",
    parkSlug: "farup-sommerland",
    attractionSlug: "farup-rafting",
    mayGetWet: true,
  },
  {
    citySlug: "ronchi",
    parkSlug: "gardaland",
    attractionSlug: "jungle-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "santa-clara",
    parkSlug: "great-america",
    attractionSlug: "rip-roaring-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "sierksdorf",
    parkSlug: "hansa-park",
    attractionSlug: "wild-water-ride-the-great-pike",
    mayGetWet: true,
  },
  {
    citySlug: "soltau",
    parkSlug: "heide-park",
    attractionSlug: "mountain-rafting",
    mayGetWet: true,
  },
  {
    citySlug: "soltau",
    parkSlug: "heide-park",
    attractionSlug: "wildwasserbahn",
    mayGetWet: true,
  },
  {
    citySlug: "hershey",
  ...
  {
    citySlug: "arlington",
    parkSlug: "hurricane-harbor-arlington",
    attractionSlug: "raging-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "santa-clarita",
    parkSlug: "hurricane-harbor-los-angeles",
    attractionSlug: "lost-temple-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "oklahoma-city",
    parkSlug: "hurricane-harbor-oklahoma-city",
    attractionSlug: "raging-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "spring",
    parkSlug: "hurricane-harbor-splashtown",
    attractionSlug: "runaway-rapids",
    mayGetWet: true,
  },
  {
  ...
  },
  {
    citySlug: "elysburg",
    parkSlug: "knoebels-amusement-park",
    attractionSlug: "giant-flume",
    mayGetWet: true,
  },
  {
    citySlug: "buena-park",
    parkSlug: "knotts-berry-farm",
    attractionSlug: "calico-river-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "billund",
    parkSlug: "legoland-billund",
    attractionSlug: "pirate-splash-battle",
    mayGetWet: true,
  },
  {
    citySlug: "guenzburg",
    parkSlug: "legoland-deutschland",
    attractionSlug: "captain-nicks-splash-battle",
    mayGetWet: true,
  },
  {
    citySlug: "nagoya",
    parkSlug: "legoland-japan",
    attractionSlug: "splash-battle",
    mayGetWet: true,
  },
  {
    citySlug: "goshen",
    parkSlug: "legoland-new-york",
    attractionSlug: "splash-battle",
    mayGetWet: true,
  },
  {
    citySlug: "chuncheon",
    parkSlug: "legoland-korea",
    attractionSlug: "splash-battle",
    mayGetWet: true,
  },
  {
  ...
  },
  {
    citySlug: "seoul",
    parkSlug: "lotte-world-adventure",
    attractionSlug: "flume-ride",
    mayGetWet: true,
  },
  {
    citySlug: "muskegon",
    parkSlug: "michigans-adventure",
    attractionSlug: "grand-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "eureka",
    parkSlug: "mid-america-parks",
    attractionSlug: "log-flume",
    mayGetWet: true,
  },
  {
    citySlug: "ravenna",
    parkSlug: "mirabilandia",
    attractionSlug: "rubbles-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "havant",
    parkSlug: "paultons-park",
    attractionSlug: "raging-river-ride-log-flume",
    mayGetWet: true,
  },
  {
    citySlug: "hassloch",
  ...
  },
  {
    citySlug: "vila-seca",
    parkSlug: "portaventura-park",
    attractionSlug: "grand-canyon-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "vila-seca",
    parkSlug: "portaventura-park",
    attractionSlug: "silver-river-flume",
    mayGetWet: true,
  },
  {
    citySlug: "new-braunfels",
    parkSlug: "schlitterbahn-nb",
    attractionSlug: "master-blaster-uphill-water-coaster",
    mayGetWet: true,
  },
  {
    citySlug: "new-braunfels",
    parkSlug: "schlitterbahn-nb",
    attractionSlug: "wasserbahn",
    mayGetWet: true,
  },
  {
    citySlug: "san-diego",
    parkSlug: "seaworld-san-diego",
    attractionSlug: "shipwreck-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "bowie",
    parkSlug: "six-flags-america",
    attractionSlug: "quantumcanyon-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "san-antonio",
    parkSlug: "six-flags-fiesta-texas",
    attractionSlug: "bugs-white-water-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "san-antonio",
  ...
  },
  {
    citySlug: "oklahoma-city",
    parkSlug: "six-flags-frontier-city",
    attractionSlug: "mystery-river-log-flume",
    mayGetWet: true,
  },
  {
    citySlug: "oklahoma-city",
    parkSlug: "six-flags-frontier-city",
    attractionSlug: "renegade-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "jackson-township",
  ...
  },
  {
    citySlug: "jackson-township",
    parkSlug: "six-flags-great-adventure",
    attractionSlug: "saw-mill-log-flume",
    mayGetWet: true,
  },
  {
    citySlug: "gurnee",
  ...
  {
    citySlug: "santa-clarita",
    parkSlug: "six-flags-hurricane-harbor-los-angeles",
    attractionSlug: "lost-temple-rapids",
    mayGetWet: true,
  },
  {
    citySlug: "marietta",
    parkSlug: "six-flags-hurricane-harbor-oklahoma-city",
    attractionSlug: "raging-rapids",
    mayGetWet: true,
  },
  {
  ...
  {
    citySlug: "marietta",
    parkSlug: "six-flags-white-water-atlanta",
    attractionSlug: "body-flumes",
    mayGetWet: true,
  },
  {
    citySlug: "singapore",
  ...
  {
    citySlug: "oxenford",
    parkSlug: "wet-n-wild-gold-coast",
